...
class FiltersApi(object):
    ...
    def create_filter_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['accept', 'authorization', 'format', 'token', 'with_model_information', 'series', 'keyword', 'frequency', 'country', 'source', 'unit', 'indicator', 'region', 'subscribed_only', 'key_only', 'new_only', 'name_only', 'start_date_before', 'end_date_after', 'created_after', 'updated_after', 'status', 'topic', 'section', 'table', 'order', 'direction']  # noqa: E501
    ...
    def delete_user_filters(self, **kwargs):  # noqa: E501
        """Delete user filters  # noqa: E501

        Delete all user created filters  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_user_filters(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_user_filters_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.delete_user_filters_with_http_info(**kwargs)  # noqa: E501
            return data

    def delete_user_filters_with_http_info(self, **kwargs):  # noqa: E501
        """Delete user filters  # noqa: E501

        Delete all user created filters  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_user_filters_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_user_filters" % key
                )
            params[key] = val
        del params['kwargs']
