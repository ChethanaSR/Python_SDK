...
class CeicSessionsFacade(object):
    ...
    def __init__(self, ceic_configuration, ceic_requests=CeicRequestsFacade()):
        ...
        # self._username = None
        # self._password = None
        self._username = "test7@apiqatest1.com"
        self._password = "Ceicapi@123$"
    ...
    def _try_call_api_login(self, username, password):
        ...
        except (ceic_exception.CeicInvalidLoginDetailsException, ceic_exception.CeicActiveSessionException) as le:
            self._username = None
            self._password = None
            raise le
