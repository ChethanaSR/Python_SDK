...
class SeriesApi(object):
    ...
    def search_series_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['accept_language', 'accept', 'authorization', 'lang', 'format', 'token', 'with_model_information', 'limit', 'offset', 'layout', 'database', 'keyword', 'frequency', 'country', 'source', 'unit', 'indicator', 'region', 'subscribed_only', 'key_only', 'new_only', 'name_only', 'start_date_before', 'end_date_after', 'created_after', 'updated_after', 'status', 'topic', 'section', 'table', 'order', 'direction', 'filter_id', 'with_replacements_metadata', 'facet']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
