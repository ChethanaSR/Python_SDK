...
class FeedsApi(object):
    ...
    def create_feed(self, filter_id, **kwargs):  # noqa: E501
        ...
        Creates a request for a feed susbscription.  # noqa: E501
    ...
    def create_feed_with_http_info(self, filter_id, **kwargs):  # noqa: E501
        ...
        all_params = ['filter_id', 'accept_language', 'accept', 'authorization', 'lang', 'format', 'token', 'with_model_information', 'consolidation', 'delivery', 'user_ftp_url', 'user_ftp_path', 'user_ftp_username', 'user_ftp_password', 'notification_email', 'notification_url', 'notification_http_method', 'frequency', 'full_dump']  # noqa: E501
