...
class Layout(object):
    ...
    def id(self, id):
        ...
        allowed_values = ["WORLD", "WGEM", "WAEM", "WFOR", "WCOM", "WCOC", "WAGR", "WASS", "WIT10", "GLOBAL", "AA", "ECA", "MEA", "NSA", "CEICGLBKS", "PMI", "DAILY", "BRAZIL", "RUSSIA", "INDIA", "INDONESIA", "CN", "OECD-MEI", "OECD-EO", "OECD-PROD"]  # noqa: E501
